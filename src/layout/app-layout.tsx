...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'store-manager', 'store-employee'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Rentals', path: '/rentals', entity: 'rental', service: AccessServiceEnum.PROJECT, icon: FiClock },
    { name: 'Stores', path: '/stores', entity: 'store', service: AccessServiceEnum.PROJECT, icon: FiShoppingBag },

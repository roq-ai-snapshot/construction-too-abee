...
import { useStoreFindFirst, useRoqClient } from 'lib/roq';
...
function StoreViewPage() {
  ...
  const { data, error, isLoading } = useStoreFindFirst(queryParams, {}, { disabled: !id });
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem
                  label="Opening Time"
                  text={data?.opening_time ? format(data?.opening_time, 'dd-MM-yyyy') : ''}
                />

                <FormListItem
                  label="Closing Time"
                  text={data?.closing_time ? format(data?.closing_time, 'dd-MM-yyyy') : ''}
                />
